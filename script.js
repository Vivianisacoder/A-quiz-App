const questions = [
  {
    question: "What is the most famous state in Nigeria?",
    answers: [
      { text: "Abia State", correct: false },
      { text: "Ogun State", correct: false },
      { text: "Imo State", correct: false },
      { text: "Lagos State", correct: true },
    ],
  },
  {
